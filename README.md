...
Activer Authentication avec la méthode « Adresse e-mail / Mot de passe », puis créer le compte du gérant
Activer Cloud Firestore
Copier la configuration web du projet dans js/firebase-config.js
Définir des règles Firestore qui autorisent la lecture publique du catalogue mais réservent l'écriture aux utilisateurs connectés :
rules_version = '2';
